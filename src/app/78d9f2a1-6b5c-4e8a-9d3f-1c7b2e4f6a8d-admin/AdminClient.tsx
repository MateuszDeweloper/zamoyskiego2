...
export default function AdminClient({ children }: { children: React.ReactNode }) {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push('/b3e7a9c2-4f8d-1e6b-9a5c-7d2f8e1b4c6a-login');
      } else {
  ...
  const getPageTitle = () => {
    if (pathname.includes('/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin/zamoyskiego-2')) {
      return 'Zarządzanie lokalami - Zamoyskiego 2';
    }
    return 'Panel administracyjny - Zamoyskiego 2';
  };
        ...
        <div className="bg-[#d7c28d] border-b border-[#c4a76a]/20 py-3">
          <div className="container mx-auto px-4 flex items-center justify-between">
            <div className="flex items-center">
              <h1 className="text-white text-xl font-medium">Panel Zamoyskiego 2</h1>
            </div>
            <button
              className="text-on-dark p-2 focus:outline-none cursor-pointer"
          ...
          <div className="p-4 space-y-4">
            ...
            <nav>
              <ul className="space-y-2">
                ...
                <li>
                  <Link
                    href="/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin"
                    className={`block px-4 py-2 rounded-xl transition-colors ${
                      pathname === '/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin'
                ...
                <li>
                  <Link
                    ...
                    className={`block px-4 py-2 rounded-xl transition-colors ${
                      pathname === '/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin/zamoyskiego-2'
                        ? 'bg-[#d7c28d]/10 text-[#d7c28d] font-medium'
                        : 'text-gray-600 hover:bg-gray-100'
                    }`}
                  >
                    <div className="flex items-center">
                      ...
                      <span className={`whitespace-nowrap ${pathname === '/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin/zamoyskiego-2' ? 'text-[#d7c28d]' : ''}`}>Zamoyskiego 2</span>
                    </div>
                  </Link>
                </li>
              </ul>
            ...
            <div className="pt-4 border-t border-gray-200">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 rounded-md bg-red-700 hover:bg-red-800 text-white transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <nav className="p-4 flex flex-col h-[calc(100%-80px)]">
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className={`whitespace-nowrap ${pathname === '/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin' ? 'text-white' : ''}`}>Strona główna</span>
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className={`whitespace-nowrap ${pathname === '/78d9f2a1-6b5c-4e8a-9d3f-1c7b2e4f6a8d-admin/zamoyskiego-2' ? 'text-white' : ''}`}>Zamoyskiego 2</span>
              </Link>
            </li>
          </ul>
          ...
          <div className="mt-auto pt-4 border-t border-gray-200">
            <button
              onClick={handleLogout}
              disabled={isLoggingOut}
              className={`w-full flex items-center px-4 py-3 rounded-md transition-colors bg-red-700 text-white hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 ${
