      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Zarządzanie inwestycją Zamoyskiego 2
          </p>
        </motion.div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="relative h-64 md:h-80 overflow-hidden">
              ...
              <div className="absolute top-6 left-6">
                <span className="bg-[#d7c28d] text-white px-4 py-2 text-sm font-medium rounded-xl shadow-lg">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-lg font-semibold">{investment.address}</span>
                </div>
              </div>
            </div>
              ...
              <div className="text-center">
                <Link href={investment.route}>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-[#d7c28d] hover:bg-[#c4a76a] text-white font-semibold px-8 py-4 text-lg rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#d7c28d] focus:ring-offset-2"
                  >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">Historia cen</h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">Status lokali</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">Plany i dokumenty</h3>
              <p className="text-sm text-gray-600">
